...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void adresgonder_Click(object sender, EventArgs e)
    {
        ...
        baglanti.Open();
        SqlCommand cmd = new SqlCommand("INSERT INTO MüsteriSiparis(AdSoyad,Adres,Telefon,Il,Ilçe,Adet,Fiyat) VALUES ('" + addtxt.Text + "','" + adrestxt.Text + "','" + telefontxt.Text + "','" + iltxt.Text + "','" + ilçetxt.Text + "','"+tutar+"','"+odenecek+"')", baglanti);
