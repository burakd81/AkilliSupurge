<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminsayfa.aspx.cs" Inherits="adminsayfa" %>
...
<body>
  ...
  <div class="slidebar">
    ...
    <ul>
      <li><a href="#anasayfa" id="targeted">Anasayfa</a></li>
  ...
  <div class="main">
    <ul class="topbar clearfix">
      <li><a href="admingiris.aspx">Çıkış</a></li>
     
    </ul>
    <div class="mainContent clearfix">
      <div id="anasayfa">
        <h2 class="header"><span class="icon"></span>Anasayfa</h2>
          <div class="monitor">
            <h4>Genel Toplam</h4>
            <div class="clearfix">
              <ul class="content">
                <li>Toplam</li>
                <li class="posts"><span class="count">
                    <asp:Label Text="asd" runat="server" id="toplamsiparislbl"/></span>Toplam Sipariş</li>
                <li class="pages"><span class="count">
                    <asp:Label Text="asd" runat="server" ID="toplammesajlbl" /></span>Toplam Mesaj</li>
                <li class="categories"><span class="count">
                    <asp:Label Text="asd" runat="server" ID="toplamadminlbl" /></span>Toplam Admin</li>
                <li class="tags"><span class="count">
                    <asp:Label Text="asd" runat="server" ID="satilanurunsayisilbl" /></span>Satılan ürün Sayısı</li>
                  <li class="tags"><span class="count">
                    <asp:Label Text="asd" runat="server" ID="toplamcirolbl" /></span>Toplam Ciro</li>
              </ul>
       ...
       <div id="siparisler">
         <h2 class="header">Gelen Siparişler</h2>
           <div class="monitor">
            <h4>Gelen Siparişler</h4>
            <div class="clearfix">
              <ul class="content">
                  <asp:ListBox runat="server" ID="lstbx">
       ...
       <div id="mesajlar">
         <h2 class="header">Gelen Mesajlar</h2>
            <div class="monitor">
            <h4>Gelen Siparişler</h4>
            <div class="clearfix">
              <ul class="content">
